...
function ControlAudio({ url,playing,setPlaying }) {
  ...
  return (
    <div>
      <CircularProgressWithLabel value={progress} children={playing  ?<PauseIcon />: <PlayArrowIcon />}/>
    </div>
  );
}


export const PlaceHolderIcon = ()=> <CircularProgressWithLabel value={0} children={<PlayArrowIcon />}/>;
